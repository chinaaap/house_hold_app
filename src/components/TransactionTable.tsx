  ...
  return (
    <Grid item xs={4} textAlign={"center"}>
      <Typography
        ...
        component={"div"}>
        {title}</Typography>
      {/* <Typography sx={{color: theme.palette.incomeColor.main}}>¥{income}</Typography> */}
      <Typography
        component={"span"}
        ...
        ¥{formatCurrency(value)}</Typography>
    </Grid>
  )
}
    ...
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        ...
        <Grid container
          ...
          {/* <Typography sx={{color: theme.palette.expenseColor.main}}>¥{expense}</Typography> */}
          {/* <Typography sx={{ color: "red" }}>¥{expense}</Typography>
            <Typography>収入</Typography> */}
          {/* <Typography sx={{color: theme.palette.balanceColor.main}}>¥{income}</Typography> */}
          {/* <Typography sx={{ color: "green" }}>¥{balance}</Typography>
          </Grid> */}
        </Grid>
